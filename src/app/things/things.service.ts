...
export class ThingsService {
    ...
    addThing(data: any) {
        ...
        return this.http.post(
        this.global.gameUrl + this.httpRequests.addThing,
        data,
        // {headers: headers} 
     )
        .map(
    ...
    getThings(data) {
        ...
        return this.http.get(
            ...
            this.global.gameUrl + this.httpRequests.getAllThings
...
deleteWord(data) {
    return this.http.delete(
        ...
        this.global.gameUrl + this.httpRequests.deleteThing+"/"+data )
    .map(
        (response: Response) => {
            const output = response.json();
            return output;
...
addCsvThings(data: any) {
    ...
    return this.http.post(
    this.global.gameUrl + this.httpRequests.addCsvThings,
    body,
 )
    .map(
        (response: Response) => {
