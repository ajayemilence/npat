...
export class HumansService {
    ...
    addAnimal(data: any) {
        ...
        this.global.gameUrl + this.httpRequests.addHuman,
        data,
     )
        .map(
            (response: Response) => {
    ...
    addCsvAnimals(data: any) {
        ...
        return this.http.post(
        this.global.gameUrl + this.httpRequests.addCsvHumans,
        body,
     )
        .map(
            (response: Response) => {
    ...
    getAllAnimals(data) {
        ...
        return this.http.get(
            this.global.gameUrl + this.httpRequests.getAllNames
...
deleteWord(data) {
    return this.http.delete(
        ...
        this.global.gameUrl + this.httpRequests.deleteName+"/"+data )
    .map(
        (response: Response) => {
            const output = response.json();
            return output;
