...
export class PlantsService {
    ...
    addPlant(data: any) {
        ...
        return this.http.post(
        this.global.gameUrl + this.httpRequests.addPlant,
        data,
        // {headers: headers} 
     )
        .map(
    ...
    getPlants(data) {
        console.log("service of plants" , data);

        return this.http.get(
            // this.global.serverUrl + 'merchant/en/get_all_merchant'
            this.global.gameUrl + this.httpRequests.getAllPlants
...
deleteWord(data) {
    return this.http.delete(
        ...
        this.global.gameUrl + this.httpRequests.deletePlant+"/"+data )
    .map(
        (response: Response) => {
            const output = response.json();
            return output;
...
addCsvPlace(data: any) {
    ...
    return this.http.post(
    this.global.gameUrl + this.httpRequests.addCsvPlants,
    body,
 )
    .map(
        (response: Response) => {
